...
private:
    ...
    void MotionCallback(const robot_msgs::msg::MotionCommand::SharedPtr msg)        
    {
        ...
        switch (msg->command) 
        {
            ...
            case 15: command_ = 15; break;  // 공 다시 잡기
    ...
    void MotionLoop()
    {
        ...
        if (callback_->IsMotionFinish())
        {
            ...
            RCLCPP_INFO(this->get_logger(),
                    "motion_end publish = %d, pick_end = %d", end_msg.motion_end_detect, end_msg.pick_end);
